...
objective_point_1 = np.array( [-0.00820956 ,-0.02067325] )
objective_point_2 = np.array( [-0.01791291 ,-0.03255892] )
objective_point_3 = np.array( [-0.02972781 ,-0.03118227])
objective_point_4 = np.array( [-0.01729624 ,-0.01552525] )
...
discret_points   = 1000                                                 #Discretitation points each ring
...
sector_end       = 90
num_subsectores  = 60                                                           #Sector divisisions
...
plt.xticks(
    subsector_limits,
    [f"{int(ang)}°" for ang in subsector_limits],
    rotation=90,
    fontsize=8
)
plt.xticks(subsector_limits, [f"{int(ang)}°" for ang in subsector_limits])
